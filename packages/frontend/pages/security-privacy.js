    ...
    <div class="container px-0 px-8 mx-auto sm:px-12 xl:px-5">
      ...
      <div class="w-full px-6 py-6 mx-auto mt-10 bg-white border border-gray-200 rounded-lg sm:px-8 md:px-12 sm:py-8 sm:shadow lg:w-5/6 xl:w-2/3">
        ...
        <p class="mt-2 text-base text-gray-600 sm:text-lg md:text-normal">
          We need you to appove on login Instagram or Facebook to get the contents of your posted only.
          The reason we need you to connect with a digital wallet, Metamask, is because we need to know your 
          account address and need you to accept the tokens minting when you convert your posted media to NFTs.
        </p>
      </div>
      <div class="w-full px-6 py-6 mx-auto mt-10 bg-white border border-gray-200 rounded-lg sm:px-8 md:px-12 sm:py-8 sm:shadow lg:w-5/6 xl:w-2/3">
        <h3 class="text-lg font-bold text-purple-500 sm:text-xl md:text-2xl">
        ...
        <p class="mt-2 text-base text-gray-600 sm:text-lg md:text-normal">
          For using Facebook or Instagram accounts to use our app, we need your login session and save 
          the access tokens in your local browser as cookies. We don't use cookies for any other purpose.
        </p>
      </div>
